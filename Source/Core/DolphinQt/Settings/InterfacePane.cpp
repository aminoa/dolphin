...
void InterfacePane::CreateUI()
{
  ...
  m_checkbox_time_tracking = new ConfigBool(tr("Enable Time Tracking"), Config::MAIN_TIME_TRACKING);
...
void InterfacePane::AddDescriptions()
{
  ...
  static constexpr char TR_DISABLE_SCREENSAVER_DESCRIPTION[] =
      QT_TR_NOOP("Disables your screensaver while running a game."
                 "<br><br><dolphin_emphasis>If unsure, leave this checked.</dolphin_emphasis>");
  static constexpr char TR_TIME_TRACKING[] =
      QT_TR_NOOP("Tracks hours/minutes while playing games and displays in the List View."
                 "<br><br><dolphin_emphasis>If unsure, leave this checked.</dolphin_emphasis>");
